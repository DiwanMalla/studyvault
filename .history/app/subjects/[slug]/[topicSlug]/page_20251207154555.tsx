...
export async function generateMetadata({
  ...
  return {
    ...
    description: topic.description || `Browse ${topic.name} documents on StudyVault`,
  };
}
...
export default async function TopicPage({
  ...
  const totalPages = topic.documents.reduce((acc, doc) => acc + doc.pageCount, 0);
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mt-6">
            ...
            {topic.description && (
              <p className="mt-2 text-gray-600 max-w-2xl">{topic.description}</p>
            )}
