...
export async function generateMetadata({
  ...
  return {
    ...
    description: subject.description || `Browse ${subject.name} topics on StudyVault`,
  };
}
...
export default async function SubjectPage({
  ...
  const totalDocuments = subject.topics.reduce(
    (acc, topic) => acc + topic._count.documents,
    0
  );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mt-6 flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              {subject.description && (
                <p className="mt-2 text-gray-600 max-w-2xl">{subject.description}</p>
              )}
