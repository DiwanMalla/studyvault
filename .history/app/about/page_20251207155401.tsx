...
export const metadata = {
  ...
  description:
    "Learn about StudyVault and our mission to provide free, secure study materials",
};
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="bg-white rounded-2xl p-8 border border-gray-200 mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              StudyVault provides free, secure access to educational study
              materials. We believe that quality education resources should be
              accessible to everyone, while also respecting and protecting the
