        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="bg-white rounded-2xl p-8 border border-gray-200 mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              for medical students. We cover Medicine, Pediatrics, Obstetrics &amp; Gynecology, 
              Surgery, and Minor subjects to help you excel in your medical education.
            </p>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Explore medical subjects and topics to find the materials you need.
                </p>
              </div>
              <div className="text-center">
