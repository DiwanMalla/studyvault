        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-sm font-medium mb-8">
              <span className="text-green-300">✓</span> 100% Free • No Login Required
            </div>
            ...
            <p className="text-lg md:text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
              Access quality study PDFs online. All documents are view-only, 
              watermarked, and protected. Start learning instantly!
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why StudyVault?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide secure, free access to study materials while protecting content creators.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600 text-sm">
                No hidden fees, no subscriptions. Access all materials at no cost.
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Secure Viewing</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600 text-sm">
                No login required. Start reading immediately without any barriers.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Browse Subjects</h2>
              <p className="text-gray-600">Explore our collection of study materials</p>
            </div>
            <Link
              href="/subjects"
          ...
          {subjects.length === 0 ? (
            <div className="text-center py-16 bg-white rounded-2xl border border-gray-200">
              ...
              <p className="text-gray-600">Check back soon for study materials!</p>
            </div>
          ) : (
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">All documents are watermarked and view-only</p>
              </div>
            </div>
