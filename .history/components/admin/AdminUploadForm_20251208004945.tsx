      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          {selectedSubjectId && topics.length === 0 && (
             <p className="mt-1 text-xs text-yellow-600 dark:text-yellow-400">This subject has no topics. Please create a topic first.</p>
          )}
        </div>
      </div>
      ...
      <div className="flex justify-between items-end gap-4">
        ...
        <button
          ...
          onClick={async () => {
            ...
            const topicName = topics.find(t => t.id === selectedTopicId)?.name || selectedSubject.name;
