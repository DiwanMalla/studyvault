...
export default function SubjectCard({
  ...
  return (
    <Link href={`/subjects/${slug}`} className="group block h-full">
      <div className="relative h-full p-6 rounded-2xl bg-card border border-border shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-gray-300 dark:hover:border-gray-600">
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="px-3 py-1 rounded-full bg-muted border border-border text-xs font-medium text-muted-foreground group-hover:bg-gray-100 dark:group-hover:bg-gray-600 transition-colors">
